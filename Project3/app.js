...
app.service('questionCollection', function() {
	var categories =
		[ {name: "Therapists",
			Questions: [ {value: 200, status: true, question: "1984", answer: "George Orwell", DD: false},
					 {value: 400, status: true, question: "1984", answer: "George Orwell", DD: false},
					 {value: 600, status: true, question: "1984", answer: "George Orwell", DD: false},
					 {value: 800, status: true, question: "1984", answer: "George Orwell", DD: false},
					 {value: 1000, status: true, question: "1984", answer: "George Orwell", DD: false}]
		  },
		  {name: "Catch These Men",
			Questions: [ {value: 200, status: true, question: "1984", answer: "George Orwell", DD: false},
					 {value: 400, status: true, question: "1984", answer: "George Orwell", DD: false},
					 {value: 600, status: true, question: "1984", answer: "George Orwell", DD: false},
					 {value: 800, status: true, question: "1984", answer: "George Orwell", DD: true},
					 {value: 1000, status: true, question: "1984", answer: "George Orwell", DD: false}]
		  },
