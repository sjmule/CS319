...
public class ConnectWindow
{
	 ...
	 * 
	 * @return true if the connection was successful false if connection failed
	 */
	boolean Connect()
	{
		try
	 ...
	 * @return String containing message if data was sent correctly fail if an error occurred
	 */
